# After Abundance: When Purpose Is All We Have Left

> What more than 200 science fiction books reveal about meaning when scarcity ends.
...
- **What Becomes Scarce?** Meaning takes the place of material needs.
...
- **Where Does Meaning Come From?** Meaning is constructed, not discovered.
- **What Happens to Work?** Work transforms into expressive choice.
- **What Replaces Capitalism?** Most imagine hybrid, pragmatic economies.

### How Has The Search For Meaning Changed Over Time?

% of books where meaning is constructed, not discovered:
- 1950s: 42%
- 2020s: 68%
- **+26 percentage points over 70 years**

In the 1950s, most science fiction assumed meaning was something to be found—in purpose, in destiny, in the universe's design. By the 2020s, the consensus has shifted: we construct meaning through choice and action.
...
**Identity dissolves in total freedom:** When you can be anyone, presenting a consistent self requires effort. Too much choice can destroy the chooser.
— Stross, Egan
...
% of books where relationships are the answer:
- 1950s: 25%
- 2020s: 53%
- **+28 percentage points over 70 years**

Earlier science fiction found meaning in struggle, discovery, and transcendence. Modern science fiction increasingly says: relationships are the point. Connection has doubled as the dominant answer.
...
**Surveillance enables tyranny, even benevolent tyranny:** The consistent message is that being watched changes behavior, that privacy enables freedom, that full transparency serves power.
— Orwell, Zamyatin, Huxley

**Perfect information destroys privacy:** In a world where everything is known, what you refuse to look at becomes the last form of freedom.
— Bester, Egan

**Utopia calcifies:** The revolutionary society hardens into orthodoxy. The founders' children enforce rules the founders broke.
— Le Guin

**Comfort is the most effective form of control:** Orwell's boot and Huxley's soma are both visible tyrannies compared to soft control.
— Huxley

**Hierarchy finds new forms:** Eliminate material competition and people compete for reputation, attention, legacy. Remove one hierarchy and another emerges.
— Banks, Doctorow

### Worlds That Show Power
...
**Automation destroys purpose before it destroys jobs:** People are materially provided for but spiritually empty. Meaning came from contribution, and the machines took that away.
...
**Without struggle, we invent new struggles:** Humans seem to need difficulty. Remove survival challenges and we create games, contests, arbitrary obstacles.
— Bester, Heinlein

**Immortality without purpose is a curse:** Endless time needs filling. When you have forever and nothing to do with it, boredom becomes the enemy.
— Reynolds, Herbert

### How Has This Changed Over Time?

% of books portraying technology as oppressive:
- 1950s: 31%
- 2020s: 9%
- **-22 percentage points over 70 years**

Contrary to popular belief, science fiction has become *less* fearful of technology over time. Early sci-fi warned of oppression; modern sci-fi treats technology as a neutral tool shaped by human choices.
...
- **How Do These Stories End?** Most end in acceptance—*accommodation.*
...
### Analysis Method
Each work was analyzed for thematic content, worldview assumptions, and responses to abundance. Analysis combined close reading with systematic tagging across 21 dimensions.
...
- **Theme** — Primary thematic concern (identity, meaning, hierarchy, connection, freedom, mortality, work, embodiment, scarcity)
- **Response** — How characters respond to abundance (acceptance, rejection, reform, transcendence, restlessness)
- **Tech Stance** — Whether technology liberates, imprisons, or is neutral
- **What Becomes Scarce** — What replaces material scarcity (meaning, identity, connection, status, freedom)
- **Identity Model** — Whether identity is fixed, fluid, constructed, or multiple
- **What Makes Life Worth Living** — Connection, struggle, creation, discovery, or transcendence
- **Death's Role** — Whether mortality gives meaning, is a problem to solve, becomes irrelevant, or is transcended
- **Work's Role** — Whether work is essential, transformed, voluntary, or irrelevant
- **Economic System** — Capitalism, hybrid, market, gift economy, or post-money
- **Hierarchy** — Whether social hierarchy persists, is escapable, or transforms
- **AI Presence** — Central, background, or absent from the narrative
- **Core Question** — The fundamental question the work asks (Who am I? How should we live? What is real?)

### Limitations & Caveats

- **Anglo-American bias:** The corpus skews heavily toward English-language science fiction. Non-Western post-scarcity imagination—from Afrofuturism to Chinese science fiction—is underrepresented, though Liu Cixin and Nnedi Okofor are included.

- **Subjective tagging:** While systematic, all tagging involves interpretation. Reasonable readers might categorize works differently. The patterns matter more than any individual classification.
...
*Part of [The Live Now Club](https://louiseireland.substack.com)*
