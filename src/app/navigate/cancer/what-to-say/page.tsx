      ...
      <div className="navigate-container">
        ...
        <article style={S.wrap}>
          ...
          <ul style={{ paddingLeft: "20px" }}>
            ...
            <li style={S.li}><span style={S.say}>“You don’t have to be strong with me.”</span> This gives the patient permission to stop performing. Almost no one else offers them that.</li>
            ...
            <li style={S.li}>Nothing. Sit with them and let them rest. Silence in good company is rest.</li>
          </ul>

          <h2 style={S.h2}>What not to say (and why)</h2>
          <ul style={{ paddingLeft: "20px" }}>
            <li style={S.li}><span style={S.say}>“At least…”</span> Any sentence that starts this way minimizes what they are living through. There is no silver lining they haven’t already searched for themselves.</li>
            ...
            <li style={S.li}><span style={S.say}>“My [relative] had cancer and…”</span> Every cancer, every body, and every outcome is different. Other people’s stories, whatever the ending, are a weight to carry.</li>
